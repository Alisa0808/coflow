...
Skill ドキュメント：[English](docs/skills/README.md) | [简体中文](docs/skills/README.zh-CN.md) | [日本語](docs/skills/README.ja.md) | [한국어](docs/skills/README.ko.md)
...
phase0-tldraw-spike/mcp-server.mjs             # Codex 向け MCP tools
phase0-tldraw-spike/server.mjs                 # ローカルキャンバスサーバー
...
plugin 開発では、local personal marketplace の `~/plugins/coflow` を `phase0-tldraw-spike` に向けてからインストールします：
